...
som plot u-matrix out/trained.yml out/u-matrix.png --data-file data.csv --label Country --ignore continent -b continent
som plot density out/trained.yml out/density.png --data-file data.csv --label Country --ignore continent -b continent
som plot error out/trained.yml out/error.png --data-file data.csv --label Country --ignore continent -b continent
...
som plot codes rose out/trained.yml out/codes-rose.png -n -s 800,600 -b continent
