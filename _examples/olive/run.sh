...
som plot density out/trained.yml out/density.png --data-file data.csv --labels id
som plot error out/trained.yml out/error.png --data-file data.csv --labels id
...
som plot density out/trained-vi.yml out/density-vi.png --data-file data.csv --labels id
som plot error out/trained-vi.yml out/error-vi.png --data-file data.csv --labels id
